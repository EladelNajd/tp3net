...
namespace RestoManager_X.Controllers
{
    public class AvisController : Controller
    {
        ...
        // GET: Avis/AvisPourUnResto
        public IActionResult AvisPourUnResto()
        {
            ViewBag.CodeResto = new SelectList(_context.Restaurants, "CodeResto", "NomResto");
            return View(new List<Avis>());
        }

        // POST: Avis/AvisPourUnResto
        [HttpPost]
        public IActionResult AvisPourUnResto(int codeResto)
        {
            ViewBag.CodeResto = new SelectList(_context.Restaurants, "CodeResto", "NomResto", codeResto);
